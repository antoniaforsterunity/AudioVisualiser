...
public class StarController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Color _color = new Color((DataGrabber._buffer[_bandNumber] * _scaleMultiplier) + _startScale, (DataGrabber._buffer[_bandNumber] * _scaleMultiplier) + _startScale, (DataGrabber._buffer[_bandNumber] * _scaleMultiplier) + _startScale, (DataGrabber._buffer[_bandNumber] * _scaleMultiplier) + _startScale);
        _glowingMaterial.SetColor("_EmissionColor", _color);

        //Debug.Log("Glow material: " + _glowingMaterial.name);
    }
}
